...
pub fn spawn_police_unit(
    ...
    ai_state.use_goap = true; // unit_type >= EscalationLevel::Tactical; // SWAT+ uses GOAP
    ...
    .insert((
        ...
        CollisionGroups::new(CIVILIAN_GROUP, Group::ALL), // This entity belongs to 'group', collides with all
